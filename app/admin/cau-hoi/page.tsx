...
function CauHoiContent() {
    ...
    <main className="h-screen overflow-hidden px-4 py-4 flex items-center justify-center" style={bgStyle}>
        <div
        className="w-full rounded-[2rem] border border-white/60 bg-white/90 p-6 shadow-2xl backdrop-blur-sm flex flex-col overflow-hidden"
...
export default function AdminCauHoi() {
    return (
    <Suspense fallback={<div className="min-h-screen bg-gray-100 flex items-center justify-center"><p>Đang tải...</p></div>}>
        <CauHoiContent />
    </Suspense>
    )
}